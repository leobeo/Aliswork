...
/** @hide */
	...
	static {
		__md_methods = 
			"";
		mono.android.Runtime.register ("Aliswork.Droid.Renderers.MyLabelRenderer, Aliswork.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", MyLabelRenderer.class, __md_methods);
	}
	...
	public MyLabelRenderer (android.content.Context p0)
	{
		super (p0);
		if (getClass () == MyLabelRenderer.class)
			mono.android.TypeManager.Activate ("Aliswork.Droid.Renderers.MyLabelRenderer, Aliswork.Android, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null", "Android.Content.Context, Mono.Android, Version=0.0.0.0, Culture=neutral, PublicKeyToken=84e04ff9cfb79065", this, new java.lang.Object[] { p0 });
	}
